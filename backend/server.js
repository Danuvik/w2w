...
//   address: String,
//   mobile: String,
//   items: [{ type: String, quantity: String }],
...
// // Middleware
// app.use(cors({
//   origin: ['http://localhost:5000', 'http://localhost'], // Adjust as needed
//   methods: ['GET', 'POST']
// }));
// app.use(bodyParser.json());
// app.use(express.static(path.join(__dirname, '../frontend')));
...
//     quantity: { type: Number, required: true, min: 1 } // Changed to Number
//   }],
//   timestamp: { type: Date, default: Date.now }
// });
...
//     // Process items - convert quantity to number
